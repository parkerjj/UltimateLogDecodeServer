package com.starstar.decode.ECC;
...
public class XlogFileDecoder {
    ...
    public static String ParseBytes(byte[] _inputBytes){
        ...
        while (true){
            ...
            retData = DecodeBuffer(_inputBytes, retData.startpos, retData.lastseq, outbuffer);
            if (-1 == retData.startpos) break;
        }

        if (0 == outbuffer.length()) return "NULL";
